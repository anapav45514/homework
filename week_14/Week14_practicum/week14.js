//Задание 1
//Создайте массив myFirstArray содержащий строки, числа, булевые значения. Выведите его в консоль.
const myFirstArray = ["строка", 25, 21, true];
console.log(myFirstArray);

//Задание 2
//Создайте массив mySecondArray, заполните его любыми значениями. Выведите длину массива.

const mySecondArray = ["test massive", 2, 15, false];
...
const myInformation = ["Анастасия", 31, 5, "Близнецы"];
...
const firstElement = countries.shift();
