...
const makeSixteen = () => {
	const str = 'JavaScript';
	resultSixteen.innerHTML = str.substr(3,);
};
...
const makeEighteen = () => {
	...
	resultEighteen.innerHTML = str.replace('world','JavaScript');
};
...
const makeTwentyOne = () => {
	min = Math.ceil(1);
    max = Math.floor(10);
    resultTwentyOne.innerHTML = Math.floor(Math.random() * (max - min + 1)) + min;
};
...
const makeTwentySeven = () => {
	min = Math.ceil(50);
    max = Math.floor(100);
    resultTwentySeven.innerHTML = Math.floor(Math.random() * (max - min + 1)) + min;
};
