...
//console.log('05'); //string
//console.log(05); //number

            //Задание 4
//Выведи в консоль строку: 'Добро '+'пожаловать, '+'твое имя.' Например, 'Добро '+'пожаловать, '+'Алиса'

//console.log('Добро '+'пожаловать, '+'Anastasia.');
...
//console.log(((128+254+137+201)/60)+' часов прокрастинировала Русалка');
